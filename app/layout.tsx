...
export const metadata: Metadata = {
  ...
  title: {
    default: "MadeHere — Find products that are actually made here.",
    template: "%s | MadeHere",
  },
  description:
    "Research American-made brands, compare products, review sourcing evidence, and shop with greater confidence.",
};
